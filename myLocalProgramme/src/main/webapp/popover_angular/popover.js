    ...
    return {
        ...
        link: function(scope,elem){
            ...
            var getTotalNumber = function () {
                ...
                totalNumber.boxLeft=elem[0].offsetLeft+210;//popover's parent's distance to window left
                ...
                totalNumber.boxRight=totalNumber.windowWidth-totalNumber.boxLeft-totalNumber.popoverParentWidth-20;//popover's parent's distance to window right
